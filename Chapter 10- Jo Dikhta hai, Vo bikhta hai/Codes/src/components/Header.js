...
const Header = () => {
  ...
  return (
    <div id="header" className='flex justify-between items-center bg-emerald-100 shadow-md'>
      <a href="/">
        <img id="logo" src={logoImage} className='w-40' alt="Hot-food-delivery-app"></img>
      </a>
      ...
      <div id="nav-items-container">
        <ul id="nav-items" className='flex justify-between px-6'>
          ...
          <li id="Cart" className='px-3'>Cart</li>
