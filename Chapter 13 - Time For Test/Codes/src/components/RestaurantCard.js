...
const RestaurantCard = (props) => {
  const { resData } = props;
  console.log(resData);
  const { name, id, cuisines, avgRating, cloudinaryImageId, costForTwo, sla } =
    resData;
  ...
  return (
    <div
      data-testid="resCard"
      className="w-56 h-[450px] object-cover m-4 border rounded-md bg-gray-100 shadow-lg hover:bg-slate-200"
    >
